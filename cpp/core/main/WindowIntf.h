...
public:
    ...
    void TJS_INTF_METHOD SetAttentionPoint(tTJSNI_BaseLayer* layer, tjs_int l, tjs_int t);
...
public: // for iTVPLayerTreeOwner
    ...
    */
    ...
    virtual void TJS_INTF_METHOD SetAttentionPoint(class iTVPLayerManager* manager,
